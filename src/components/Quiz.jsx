...
const Quiz = () => {
    ...
    return <div>
        ...
        <div className="grid my-4">
            {quizQuestion[i].answers.map((answer, index) => (<button key={index} onClick={handleClick} className={`${animation} rounded p-3 my-3 block btn btn__primary`}>{answer}</button>))}
        </div>
    </div>
}
